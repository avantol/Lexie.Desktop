...
public class DxccLookupService
{
    private static readonly Dictionary<string, string> PrefixMap = new()
    {
        ...
        ["VE"] = "Canada", ["VF"] = "Canada", ["VG"] = "Canada", ["VO"] = "Canada",
        ["VX"] = "Canada", ["VY"] = "Canada",
        ["CY"] = "Canada", ["CZ"] = "Canada", ["CF"] = "Canada", ["CG"] = "Canada",
        ["CH"] = "Canada", ["CI"] = "Canada", ["CJ"] = "Canada", ["CK"] = "Canada",
        // Mexico
        ["XA"] = "Mexico", ["XB"] = "Mexico", ["XC"] = "Mexico", ["XD"] = "Mexico",
        ["XE"] = "Mexico", ["XF"] = "Mexico",
        ["4A"] = "Mexico", ["4B"] = "Mexico", ["4C"] = "Mexico",
        ["6D"] = "Mexico", ["6E"] = "Mexico", ["6F"] = "Mexico", ["6G"] = "Mexico", ["6H"] = "Mexico",
        // Europe
        ...
        ["F"] = "France", ["HW"] = "France", ["HX"] = "France", ["HY"] = "France",
        ["TH"] = "France", ["TM"] = "France", ["TO"] = "France", ["TP"] = "France",
        ["TQ"] = "France", ["TV"] = "France",
        ["DL"] = "Germany", ["DA"] = "Germany", ["DB"] = "Germany", ["DC"] = "Germany",
        ["DD"] = "Germany", ["DE"] = "Germany", ["DF"] = "Germany", ["DG"] = "Germany",
        ["DH"] = "Germany", ["DI"] = "Germany", ["DJ"] = "Germany", ["DK"] = "Germany",
        ...
        ["OX"] = "Greenland", ["XP"] = "Greenland", ["OY"] = "Faroe Islands",
        ...
        ["LZ"] = "Bulgaria",
        ["YU"] = "Serbia", ["YT"] = "Serbia",
        ["Z3"] = "North Macedonia", ["9A"] = "Croatia", ["S5"] = "Slovenia",
        ["E7"] = "Bosnia-Herzegovina", ["4O"] = "Montenegro", ["ZA"] = "Albania",
        ["SV"] = "Greece", ["SW"] = "Greece", ["SX"] = "Greece", ["SY"] = "Greece", ["SZ"] = "Greece",
        ["J4"] = "Greece", ["SV5"] = "Dodecanese", ["SV9"] = "Crete",
        ...
        ["TF"] = "Iceland", ["LX"] = "Luxembourg", ["9H"] = "Malta",
        ["4U1V"] = "Vienna Intl Centre", ["JY"] = "Jordan",
        // South America
        ["LU"] = "Argentina", ["LO"] = "Argentina", ["LP"] = "Argentina", ["LQ"] = "Argentina",
        ["LR"] = "Argentina", ["LS"] = "Argentina", ["LT"] = "Argentina", ["LV"] = "Argentina",
        ["LW"] = "Argentina", ["AY"] = "Argentina", ["AZ"] = "Argentina",
        ...
        ["HC"] = "Ecuador", ["HD"] = "Ecuador", ["HC8"] = "Galapagos Islands",
        ...
        ["9Y"] = "Trinidad & Tobago", ["8R"] = "Guyana", ["PZ"] = "Suriname",
        ["PJ2"] = "Curacao", ["PJ4"] = "Bonaire", ["PJ5"] = "Sint Eustatius",
        ["PJ6"] = "Saba", ["PJ7"] = "Sint Maarten", ["FY"] = "French Guiana",
        ...
        ["HI"] = "Dominican Republic", ["HH"] = "Haiti", ["4V"] = "Haiti",
        ["6Y"] = "Jamaica",
        ["VP5"] = "Turks & Caicos Islands",
        ["VP2E"] = "Anguilla", ["VP2M"] = "Montserrat", ["VP2V"] = "British Virgin Islands",
        ["V2"] = "Antigua & Barbuda", ["J3"] = "Grenada", ["J6"] = "Saint Lucia",
        ["J7"] = "Dominica", ["J8"] = "Saint Vincent", ["V4"] = "Saint Kitts & Nevis",
        ["8P"] = "Barbados", ["FM"] = "Martinique", ["FG"] = "Guadeloupe",
        ["FS"] = "Saint Martin", ["FJ"] = "Saint Barthelemy",
        ["VP9"] = "Bermuda", ["ZF"] = "Cayman Islands", ["C6"] = "Bahamas",
        // Asia
        ...
        ["6K"] = "South Korea", ["6L"] = "South Korea", ["6M"] = "South Korea", ["6N"] = "South Korea",
        ["BV"] = "Taiwan", ["BW"] = "Taiwan", ["BX"] = "Taiwan", ["BM"] = "Taiwan",
        ["BN"] = "Taiwan", ["BO"] = "Taiwan", ["BP"] = "Taiwan", ["BQ"] = "Taiwan",
        ...
        ["9M2"] = "West Malaysia", ["9M4"] = "West Malaysia",
        ["9M6"] = "East Malaysia", ["9M8"] = "East Malaysia",
        ["9V"] = "Singapore",
        ...
        ["VU"] = "India", ["VT"] = "India", ["VW"] = "India",
        ["8T"] = "India", ["8U"] = "India", ["8V"] = "India", ["8W"] = "India",
        ["8X"] = "India", ["8Y"] = "India",
        ["AP"] = "Pakistan", ["AQ"] = "Pakistan", ["AR"] = "Pakistan", ["AS"] = "Pakistan",
        ["6P"] = "Pakistan", ["6Q"] = "Pakistan", ["6R"] = "Pakistan", ["6S"] = "Pakistan",
        ["4S"] = "Sri Lanka", ["S2"] = "Bangladesh",
        ["XU"] = "Cambodia", ["XW"] = "Laos", ["XZ"] = "Myanmar",
        ["9N"] = "Nepal", ["A5"] = "Bhutan",
        ["EX"] = "Kyrgyzstan", ["EY"] = "Tajikistan", ["EZ"] = "Turkmenistan",
        ["UK"] = "Uzbekistan",
        ["UN"] = "Kazakhstan", ["UL"] = "Kazakhstan", ["UM"] = "Kazakhstan",
        ["UP"] = "Kazakhstan", ["UQ"] = "Kazakhstan",
        ["EP"] = "Iran", ["EQ"] = "Iran",
        ["YI"] = "Iraq", ["HN"] = "Iraq", ["OD"] = "Lebanon", ["YK"] = "Syria",
        ["4X"] = "Israel", ["4Z"] = "Israel",
        ["HZ"] = "Saudi Arabia", ["7Z"] = "Saudi Arabia",
        ["A4"] = "Oman", ["A6"] = "United Arab Emirates", ["A7"] = "Qatar",
        ["A9"] = "Bahrain", ["9K"] = "Kuwait",
        ["EK"] = "Armenia", ["4J"] = "Azerbaijan", ["4K"] = "Azerbaijan", ["4L"] = "Georgia",
        ["T5"] = "Somalia",
        // Africa
        ...
        ["ST"] = "Sudan", ["ET"] = "Ethiopia",
        ["5Z"] = "Kenya", ["5H"] = "Tanzania", ["5I"] = "Tanzania",
        ["5X"] = "Uganda", ["9U"] = "Burundi", ["9X"] = "Rwanda",
        ["TL"] = "Central African Republic", ["TN"] = "Republic of the Congo",
        ["9Q"] = "Democratic Republic of the Congo",
        ["TR"] = "Gabon", ["TJ"] = "Cameroon", ["TT"] = "Chad",
        ["5T"] = "Mauritania", ["5U"] = "Niger", ["5V"] = "Togo",
        ["TU"] = "Ivory Coast", ["TY"] = "Benin", ["XT"] = "Burkina Faso",
        ["6W"] = "Senegal", ["EL"] = "Liberia", ["C5"] = "The Gambia",
        ["J5"] = "Guinea-Bissau", ["3X"] = "Guinea",
        ["9L"] = "Sierra Leone", ["9G"] = "Ghana", ["D4"] = "Cape Verde",
        ["3C"] = "Equatorial Guinea", ["S9"] = "Sao Tome & Principe",
        ["V5"] = "Namibia",
        ["ZS"] = "South Africa", ["ZR"] = "South Africa", ["ZT"] = "South Africa", ["ZU"] = "South Africa",
        ["A2"] = "Botswana", ["7P"] = "Lesotho", ["3DA"] = "Eswatini",
        ["Z8"] = "South Sudan", ["E3"] = "Eritrea", ["D6"] = "Comoros",
        ["5R"] = "Madagascar",
        ["3B8"] = "Mauritius", ["3B9"] = "Rodrigues Island",
        ["FR"] = "Reunion Island", ["FH"] = "Mayotte", ["VQ9"] = "Chagos Islands",
        // Oceania
        ...
        ["ZL7"] = "Chatham Islands", ["ZL8"] = "Kermadec Islands",
        ["ZL9"] = "Auckland & Campbell Islands",
        ["FK"] = "New Caledonia", ["FO"] = "French Polynesia", ["YJ"] = "Vanuatu",
        ["3D2"] = "Fiji", ["A3"] = "Tonga", ["5W"] = "Samoa",
        ["T3"] = "Kiribati", ["V7"] = "Marshall Islands", ["V6"] = "Micronesia",
        ["T8"] = "Palau", ["P2"] = "Papua New Guinea", ["H4"] = "Solomon Islands",
        ["T2"] = "Tuvalu", ["ZK3"] = "Tokelau", ["E5"] = "Cook Islands",
        ["E6"] = "Niue", ["ZK2"] = "Niue",
        // Special
        ["1A"] = "Sovereign Military Order of Malta", ["4U1U"] = "United Nations HQ",
    };

    // Pre-sorted by length descending for longest-match-first lookup
    private static readonly string[] SortedPrefixes =
        PrefixMap.Keys.OrderByDescending(k => k.Length).ToArray();

    public string? Lookup(string callsign)
    {
        if (string.IsNullOrWhiteSpace(callsign)) return null;
        var baseCall = callsign.ToUpperInvariant().Split('/')[0];

        foreach (var prefix in SortedPrefixes)
        {
            if (baseCall.StartsWith(prefix, StringComparison.Ordinal))
